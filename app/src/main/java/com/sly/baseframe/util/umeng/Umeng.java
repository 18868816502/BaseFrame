...
import com.sly.baseframe.common.BuildConfig;
...
/**
 * @author xst 修复 UMConfigure.init 写死为umeng的问题
 * @version 3.0.1
 */
public class Umeng {
    public static void install(Context context) {
         ...
         * 参数5:Push推送业务的secret
         */
        UMConfigure.init(context, BuildConfig.UMENG_APP_KEY, MyApplication.sChannelId, UMConfigure.DEVICE_TYPE_PHONE, "");
        //统计使用
